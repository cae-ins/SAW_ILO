...
global outputs "$projet\Rural\outputs" // Insert the path to the outputs (Excel File)
global temp "$projet\Rural\temp" // Insert the path to the temporary files
global do_files "$projet\Rural\do_files"
