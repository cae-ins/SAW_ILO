...
global outputs "$projet\Abidjan\outputs" // Insert the path to the outputs (Excel File)
global temp "$projet\Abidjan\temp" // Insert the path to the temporary files
global do_files "$projet\Abidjan\do_files"
